...
class VisionTransformer(nn.Module):
    ...
    def forward_pos_embed(self, x, camera_id, view_id):
        ...
        if self.cam_num > 0 and self.view_num > 0:
            x = x + self.pos_embed + self.sie_xishu * \
                self.sie_embed[camera_id * self.view_num + view_id]
        elif self.cam_num > 0:
    ...
    def forward_features(self, x, camera_id, view_id, start_at_block, stop_at_block, save_feat_cash=False):
        """
        params: stop_at_block: stop at the block idx, 0 means all blocks, -1 means last 1 blocks
        """
        if stop_at_block == 0:
    ...
    def load_param(self, model_path):
        ...
        for k, v in param_dict.items():
            ...
            try:
                ...
                self.state_dict()[k].copy_(v)
                print('===========================CORRECT=========================')
                print('shape in k:{}(param_dict) {} resized to {} by xhao'.format(
