...
if __name__ == "__main__":
    ...
    for idx, dataset_name in enumerate(cfg.DATASETS.TESTS):
        train_loader, train_loader_normal, val_loader, num_query, num_classes, camera_num, view_num, dataset = make_dataloader(
            cfg, dataset_name, train=False)
        cfg.defrost()
        ...
        do_inference(cfg, dataset_name, model, val_loader, num_query)
